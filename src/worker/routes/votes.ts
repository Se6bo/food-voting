...
votes.post("/", async (c) => {
  ...
  if (!day) return c.json({ error: "Für diesen Tag ist kein Essen geplant." }, 404);
...
/** Eigene Stimme zurücknehmen, solange die Abstimmung offen ist. */
